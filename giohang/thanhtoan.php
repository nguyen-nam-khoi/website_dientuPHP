...
if (isset($_POST['ThanhToan'])) {
    ...
    if($them2) {
        echo'<div class="list">Đã đặt hàng thành công theo phương thức nhận hàng kiểm tra và thanh toán nhé :3 - <a href="/donhang/index.php?mod=chitiet&id='.$maddh.'">Đến chi tiết đơn hàng </a></div>';
        unset($_SESSION['cart']); 
    }
}
