...
<script src="OwlCarousel2-2.3.4/dist/owl.carousel.min.js"></script>
    ...
    <link rel="stylesheet" href="/giaodien/stylegiaodien.css">
...
<body>
    <div class="header">
        <div class="topbar">
            <div class="center">
                <span>Rất vui khi được phục vụ quý khách</span>
                <ul class="listtopbar">
                    ...
                    <li><a href="khuyenmai.php"><i style='font-size:12px' class='fas'>&#xf005;</i> Khuyến mãi hot</a></li>
                </ul>
            </div>
        </div> 
        <div class="cenbar">
            <div class="center">
                ...
                <a class="logo" href="/"><span style="color:white;font-size:46px;" >Shop Shop</span></a>
                <div class="search">
                    <form action="timkiem.php" method="get"><input type="text" size="50" name="search" placeholder="Nhập sản phẩm bạn tìm kiếm" style="display: inline-block;">
        ...
        <div class="thanhmenu">
            <div class="center">
                ...
                <li id="danhmucsp">
                    ...
                    <li id="m"><a href="khuyenmai.php">KHUYẾN MÃI</a></li id="m">
